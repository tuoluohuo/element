            ...
            _vm._b(
              {
                ...
                domProps: {
                  value:
                    _vm.displayValue &&
                    _vm.displayValue[0].replace(" 00:00:00", "")
                },
                on: {
            ...
            _vm._b(
              {
                ...
                domProps: {
                  value:
                    _vm.displayValue &&
                    _vm.displayValue[1].replace(" 00:00:00", "")
                },
                on: {
                              ...
                              [
                                _c("el-input", {
                                  ...
                                  attrs: {
                                    ...
                                    placeholder:
                                      _vm.t("el.datepicker.startDate") +
                                      " (yyyy-MM-dd)",
                                    value: _vm.minVisibleDate
                                  },
                                  on: {
                                    blur: function($event) {
                                      _vm.handleDateBlur("min")
                                    },
                                    input: function(val) {
...
/* harmony default export */ var date_rangevue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      minDate: '',
      maxDate: '',
      leftDate: Object(date_util_["prevMonth"])(new Date()),
      rightDate: new Date(),
      rangeState: {
        endDate: null,
        selecting: false,
    ...
    defaultValue: function defaultValue(val) {
      if (!Array.isArray(this.value)) {
        ...
        if (this.disabledType === 'next') {
          this.leftDate = Object(date_util_["prevMonth"])(new Date());
          this.rightDate = left;
        } else {
          this.leftDate = left;
  ...
  methods: {
    ...
    handleDateBlur: function handleDateBlur(type) {
      var value = type === 'min' ? this.minVisibleDate || '' : this.maxVisibleDate || '';
      var reg1 = /^\d{4}\-\d{1}\-\d{1}$/;
      var reg2 = /^\d{4}\-\d{1}\-\d{2}$/;
      var reg3 = /^\d{4}\-\d{2}\-\d{1}$/;
      if (reg1.test(value)) {
        //自动补0
        var arr = value.split('-');
        ...
        value = _arr[0] + '-0' + _arr[1] + '-' + _arr[2];
      } else if (reg3.test(value)) {
        var _arr2 = value.split('-');
        value = _arr2[0] + '-' + _arr2[1] + '-0' + _arr2[2];
      }
